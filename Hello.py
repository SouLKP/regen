...
def first_query_engine(extracted_text):  
    documents = SimpleDirectoryReader("/home/webclues/Music/HR_Gen_1/txt_file").load_data()
    # document = Document(extracted_text)
    # documents = [document]
    llm = OpenAI(temperature=0.2, model="gpt-4", max_tokens=4096, timeout= 120) 
...
def create_summary_docx(title,summary,skill,role,resume_format):  
        if resume_format == 'web':
            filename = '/home/webclues/Music/HR_Gen_1/logo/wlog.png'
            width = Cm(5.39)
            height = Cm(0.76) #0.68
            #title color
            #line color
            ...
            filename = '/home/webclues/Music/HR_Gen_1/logo/clog.png'
            width = Cm(5.44)
            height = Cm(0.69)
        ...
        #     title_paragraph.paragraph_format.line_spacing = 0.1 #0.3
        #     title_run = title_paragraph.runs[0]
        #     title_run.bold = False
        #     title_run.font.name = 'Arial MT'
...
def last(doc,projects_string,save_file_path):    
    ...
    run.font.size = Pt(15)
    run.font.name = 'calibri'
    # run.font.color.rgb = RGBColor(204,64,37)
    ...
    #         print(title, role, description,tech,'\n','!!!!!!!!!!!!!!!!!!!!!!')
    #         add_project(doc,title, role, description,tech)  
        
    # except Exception as e:
    #     title = doc.add_paragraph(projects_list)
    #     print("error in this doc")
    #     pass
    ...
    doc.save('/home/webclues/Music/HR_Gen_1/output/final_resume.docx')
...
save_file_path = os.path.join('/home/webclues/Music/HR_Gen_1/output','final_resume.docx')
output_dir = os.path.join('/home/webclues/Music/HR_Gen_1/output')  
...
if submit_button:    
    if resume1 is not None:
        ...
        #extra_code
        with open("/home/webclues/Music/HR_Gen_1/txt_file/text.txt",'w') as f:
            f.write(extracted_text)

        engine = first_query_engine(extracted_text)
...
file_path1 = '/home/webclues/Music/HR_Gen_1/output/final_resume.pdf'
file_path2 = '/home/webclues/Music/HR_Gen_1/output/final_resume.docx'
